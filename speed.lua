...
local w = ui:NewWindow('hack tốc độ',250,200)

local m = w:NewMenu('hack tốc độ')
local t = m:NewToggle('nhấn vô để hack tốc độ')
local s = m:NewSlider('chọn lượng tốc độ',1,50,5)

t:SetTooltip("toggles speedhacks")
s:SetTooltip("speedhack speed")

m:NewLabel()
m:NewLabel('được làm bởi thành')
