...
Tab:AddButton(
    {
        ...
        Callback = function()
            ...
            loadstring(game:HttpGet(("https://raw.githubusercontent.com/b3styskid/MAZI-API/main/Fast_Attack.lua"), true))()
        end
    }
)
Tab:AddButton(
    {
        ...
        Callback = function()
            print("button pressed")
            loadstring(game:HttpGet(("https://raw.githubusercontent.com/lewherin/hi/main/fpsboss"), true))()
        end
    }
)