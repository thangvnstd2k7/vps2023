...
local Library = Update:Window("thanh evo","hub",Enum.KeyCode.RightControl);
Main = Library:Tab("phần chính",6026568198)
Ss = Library:Tab("tự nâng chỉ số",7040410130)
P = Library:Tab("pvp",7251993295)
T = Library:Tab("dịch chuyển",6035190846)
R = Library:Tab("raid",7044284832)
S = Library:Tab("mua đồ",6031265976)
D = Library:Tab("trái ác quỷ",7044233235)
Misc = Library:Tab("Misc Game",6034509993)

Main:Seperator("chào mừng đến bản hack của thành")

Main:Button("sao chép link ytb",function()
    setclipboard("https://youtube.com/@ngocthanhtran3010")
end)
...
Main:Toggle("tự động farm lv",_G.AutoFarm,function(value)
        _G.AutoFarm = value
        _G.Seet = value
        _G.M = value
    ...
    Main:Toggle("tự farm Boss",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:Toggle("tự đánh tất cả Boss",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:Toggle("tự đánh tất cả Boss Hop",_G.AutoAllBossHop,function(value)
...
Main:Toggle("mang con quái",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
    ...
    Main:Toggle("mang con quái nhanh",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
Main:Toggle("đánh nhanh 5",false,function(value)
    ...
    Main:Toggle("đánh siu nhanh 1",false,function(value)
...
while cac() do 
	AttackNoCD()
        ...
        Main:Toggle("đánh siu nhanh 2",nil,function(value)
...
spawn(function()
    ...
    Main:Toggle("xóa Attack",false,function(value)
...
spawn(function()
    ...
    Main:Toggle("xóa Attack FIx",nil,function(d)
    _G.DeleteAttackFx = d
...
Main:Seperator("World")
        ...
        Main:Toggle("tự làm nv qua sea 2",_G.AutoSecondSea,function(value)
    ...
    Main:Toggle("tự làm nv qua sea 3",_G.AutoThirdSea,function(value)
    ...
    if World2 then
        ...
        Main:Toggle("tự động farm nhà máy",_G.AutoFactory,function(value)
   ...
   Main:Seperator("Misc Mastery")
    ...
    Main:Toggle("tự động farm mas df",_G.AutoFarmFruitMastery,function(value)
    ...
    Main:Button("mua chip raid law",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    Main:Button("bât đầu raid law",function()
        if World2 then
    ...
    spawn(function()
        ...
        Main:Button("đang kiểm tra số xương", function()
    ...
    Main:Toggle("tự động farm vật chất kì dj",_G.AutoEctoplasm,function(value)
    ...
    Main:Toggle("tự động nâng tộc v2",_G.Auto_EvoRace,function(value)
    ...
    Main:Toggle("tự làm nv Bartlio",_G.AutoBartilo,function(value)
...
spawn(function()
    ...
    P:Button("tự động nhiệm vụ săn người chơi",function()
    ...
    P:Toggle("mở pvp",false,function(value)
        _G.EnabledPvP = value
    end)
    ...
    P:Toggle("tự động càyBounty",_G.AutoFarmBounty,function(value)
    ...
    P:Toggle("tư động cày Bounty Hop",_G.AutoFarmBounty_Hop,function(value)
    ...
    P:Toggle("bắt đầu khóa bounty",false,function(value)
...
T:Seperator("World")
    ...
    T:Button("dịch chuyển đến sea 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:Button("dịch chuyển đến sea 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:Button("dịch chuyển đến sea 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:Button("dịch chuyển đên vua biển",function()
    ...
    if World3 then
        T:Dropdown("chọn đảo",{
            ...
            "Castle On The Sea",
            "MiniSky", 
            "Hydra Island",tham gia Team hải tặc
            "Floating Turtle",
            "Haunted Castle",
            "Ice Cream Island",
            "Peanut Island",
    ...
    T:Toggle("dịch chuyển",false,function(value)
        ...
        pcall(function()
            while wait() do
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Timer.Visible == true then
                    ...
                    TimeRaid:Set("Wait For Dungeon0")
                end
            end
        end)
    end)
    
        R:Toggle("tự động raid",_G.Auto_Dungeon,function(value)
    ...
    R:Toggle("tự động thức tỉnh (sẻ bị kẹt ở nơi thức tỉnh)",_G.Auto_Awakener,function(value)
...
spawn(function()
    ...
    R:Dropdown("chọn chip",{"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix"},function(value)
        _G.SelectChip = value
    end)
    
    R:Toggle("tự động chọn raid đã chọn",_G.AutoSelectDungeon,function(value)
    ...
    R:Toggle("tự động bắt đầu raid",_G.Auto_StartRaid,function(value)
    ...
    D:Toggle("tự động ăn fruit Hop",_G.AutoEatFruitHop,function(value)
    ...
    D:Toggle("tự động bốc fruit",_G.Random_Auto,function(value)
    ...
    D:Button("bốc fruit",function()
        ...
        D:Button("mở shop bán fruit",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    D:Toggle("tự động vức fruit",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    D:Toggle("tự động lưu fruit",_G.AutoStoreFruit,function(value)
    ...
    D:Toggle("lụm fruit",_G.BringFruit,function(value)
        ...
        D:Toggle("nhặt tất cả fruit",_G.BringFruitBF,function(value)
    ...
    Misc:Button("mở shop bán fruit",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
...
Misc:Button("màu haki",function()
    ...
    Misc:Button("tham gia Team hải tặc",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Misc:Button("tham gia Team hải quân",function()
    ...
    Misc:Button("item click dịch chuyển",function()
    ...
    Misc:Toggle("đồ họa đẹp",_G.RTXMode,function(value)
        _G.RTXMode = value
    ...
    Misc:Toggle("xóa sương mù",RemoveFog,function(value)
        RemoveFog = value
    ...
    Misc:Button("mở khóa fps",function()
     ...
     Misc:Button("chế độ giả skin™",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
    ...
    Misc:Toggle("ESP hoa",false,function(value)
        FlowerESP = value
    ...
    Misc:Toggle("lướt không thời gian hồi",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    ...
    Misc:Toggle("tự động kích hoạt tộc",_G.AutoAgility,function(value)
    ...
    Misc:Toggle("vô hạn sức chiệu đựng của ken",getgenv().InfiniteObRange,function(value)
