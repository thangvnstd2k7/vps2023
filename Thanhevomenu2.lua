...
local Library = Update:Window("thanh evo","blox-fruit",Enum.KeyCode.RightControl);
Main = Library:Tab("chính",6026568198)
Ss = Library:Tab("tự động nâng chỉ số",7040410130)
P = Library:Tab("người chơi",7251993295)
T = Library:Tab("dịch chuyển",6035190846)
R = Library:Tab("raid",7044284832)
S = Library:Tab("mua vật phẩm",6031265976)
D = Library:Tab("trái ác quỷ",7044233235)
Misc = Library:Tab("Misc Game",6034509993)

Main:Seperator("chào bạn đến script thanh evo")
...
Main:Toggle("tự chọn điểm spawn",true,function(x)
    _G.Set = x
end)
...
Main:Toggle("tự động cày lever",_G.AutoFarm,function(value)
        _G.AutoFarm = value
        _G.Seet = value
        _G.M = value
    ...
    Main:Toggle("tự đánh con katakuri",_G.AutoDoughtBoss,function(value)
    ...
    local BossName = Main:Dropdown("chọn boss Boss",Boss,function(value)
        _G.SelectBoss = value
    end)
    ...
    Main:Toggle("tự động farm Boss",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:Toggle("tự động farm tất cả Boss",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:Toggle("tự động farm tất cả Boss Hop",_G.AutoAllBossHop,function(value)
...
spawn(function()
    ...
    Main:Toggle("đánh nhanh 1",true,function(value)
        _G.FastAttack = value
    end)      
    
    Main:Toggle("đánh nhanh 2",nil,function(value)
...
spawn(function()
    ...
    Main:Toggle("đánh nhanh 3",false,function(Fast)
    _G.FastAttack = Fast
end)
...
Main:Toggle("đánh nhanh 4",false,function(value)
...
Main:Toggle("đánh nhanh 5",false,function(value)
            _G.FastAttack = value
        end)



    Main:Toggle("đánh rất nhanh 1",false,function(value)
...
while cac() do 
	AttackNoCD()
        ...
        Main:Toggle("đánh rất nhanh 2",nil,function(value)
...
Main:Seperator("World")
        ...
        Main:Toggle("tự động làm nv qua sea 2",_G.AutoSecondSea,function(value)
    ...
    Main:Toggle("tự động làm nv qua sea 3",_G.AutoThirdSea,function(value)
    ...
    if World2 then
        ...
        Main:Toggle("tự động đánh nhà máy",_G.AutoFactory,function(value)
   ...
   Main:Seperator("Misc Mastery")
    ...
    Main:Toggle("tự động farm Mastery fruit,_G.AutoFarmFruitMastery,function(value)
    ...
    Main:Toggle("tự động farm Mastery súng",_G.AutoFarmGunMastery,function(value)
    ...
    Main:Toggle("tự động lấy Buddy Sword",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    Main:Toggle("tự động lấy Buddy Sword Hop",_G.AutoBudySwordHop,function(value)
    ...
    Main:Toggle("tự động lấy kiếm koko (mới!)", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    Main:Toggle("tự lấy kiếm koko Hop (mới!)", _G.AutoOderSwordHop,function(value)
    ...
    Main:Button("mua chip law",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    Main:Button("bắt đầu raid law",function()
        if World2 then
    ...
    Main:Toggle("tự động làm nv Elite Hunter",_G.AutoElitehunter,function(value)
    ...
    Main:Toggle("tự động làm nv Elite Hunter Hop",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    Main:Seperator("Misc Hallow Scythe")
    
    Main:Toggle("tự động lấy Hallow Scythe",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    Main:Toggle("tự động lấy Hallow Scythe Hop",_G.AutoFarmBossHallowHop,function(value)
    ...
    Main:Toggle("tự động giết Admin Boss",_G.AutoDarkDagger,function(value)
    ...
    Main:Toggle("tự động giết Admin Boss Hop",_G.AutoDarkDagger_Hop,function(value)
    ...
    Main:Toggle("tự động lấy Swan Glasses",_G.AutoFarmSwanGlasses,function(value)
    ...
    Main:Toggle("tự động lấy Swan Glasses Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
    ...
    local BoneFarm = Main:Toggle("tự động farm xương",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    spawn(function()
        ...
        Main:Button("kiểm tra số xương", function()
    ...
    Main:Toggle("Auto Farm haki quan sát",_G.AutoObservation,function(value)
    ...
    Main:Toggle("Auto Farm haki quan sát Hop",_G.AutoObservation_Hop,function(value)
    ...
    Main:Toggle("tự động lấy Saber",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        StopTween(_G.AutoSaber)
    end)
    
    Main:Toggle("tự động lấy Saber Hop",_G.AutoSaber_Hop,function(value)
    ...
    Main:Toggle("tự động lấy Legendary Sword",_G.AutoBuyLegendarySword,function(value)
    ...
    Main:Toggle("tự động lấy Musketeer",_G.AutoMusketeerHat,function(value)
    ...
    Main:Toggle("tự động lấy haki bảy màu",_G.Auto_Rainbow_Haki,function(value)
    ...
    Main:Toggle("tự động lấy haki quan sát v2",_G.AutoObservationv2,function(value)
    ...
    Main:Toggle("tự động lấy Rengoku",_G.AutoRengoku,function(value)
    ...
    Main:Toggle("tự động farm vật chất kì dị",_G.AutoEctoplasm,function(value)
    ...
    Main:Toggle("tự động lấy Yama",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    Main:Toggle("tự động nân tộc v2",_G.Auto_EvoRace,function(value)
    ...
    Main:Toggle("tự động làm nhiệm vụ Bartlio",_G.AutoBartilo,function(value)
...
Ss:Toggle("phòng thủ",false,function(value)
defense = value
end)
...
PointStats = 1
Ss:Slider("số điểm",1,100,PointStats,nil,function(value)
PointStats = value
end)
...
spawn(function()
    ...
    P:Toggle("xem theo góc nhìn người chơi",false,function(value)
        SpectatePlys = value
    ...
    P:Toggle("dịch chuyển",false,function(value)
    ...
    P:Toggle("tự động farm người chơi",false,function(value)
    ...
    P:Button("tự động nhiệm vụ người chơi",function()
    ...
    P:Toggle("Aimbot súng",false,function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    P:Toggle("chế độ an toàn",false,function(value)
        _G.Safe_Mode = value
    ...
    P:Toggle("tự động farm bounty",_G.AutoFarmBounty,function(value)
    ...
    P:Toggle("tự động farm bounty hop",_G.AutoFarmBounty_Hop,function(value)
    ...
    P:Button("người chơi khác",function()
        NextplySelect = true
        wait(.1)
        NextplySelect = false
    end)
    
    P:Slider("khóa bounty",1,25000000,750000,function(value)
        _G.BountyLock = value
    end)
    
    P:Toggle("bắt đầu khoa bounty",false,function(value)
...
T:Seperator("World")
    ...
    T:Button("dịch chuyển tới sea 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:Button("dịch chuyển tới sea 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:Button("dịch chuyển tới sea 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:Button("dịch chuyển đến thủy quái",function()
    ...
    spawn(function()
        ...
        R:Toggle("tự farm raid",_G.Auto_Dungeon,function(value)
    ...
    R:Toggle("tự động thức tỉnh",_G.Auto_Awakener,function(value)
...
spawn(function()
    ...
    R:Toggle("chọn chip raid",_G.AutoSelectDungeon,function(value)
    ...
    R:Toggle("tự động mua chip",_G.AutoBuyChip,function(value)
    ...
    R:Button("mua chip raid đã chọn",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    R:Toggle("tự động zô raid",_G.Auto_StartRaid,function(value)
    ...
    R:Button("bắt đầu zô raid",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
        ...
        R:Button("qua đảo tiếp theo",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    ...
    D:Dropdown("chọn fruit để ăn",FruitList,function(value)
        _G.SelectFruitEat = value
    end)
    
    D:Toggle("tự động ăn fruit",_G.AutoEatFruit,function(value)
    ...
    D:Toggle("tự dộng ăn fruit Hop",_G.AutoEatFruitHop,function(value)
    ...
    D:Toggle("tự động bố fruit",_G.Random_Auto,function(value)
    ...
    D:Toggle("tự động nén fruit",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    D:Toggle("tự động bỏ fruit vô túi",_G.AutoStoreFruit,function(value)
    ...
    D:Toggle("lụm fruit",_G.BringFruit,function(value)
        _G.BringFruit = value
        pcall(function()
        ...
        D:Toggle("lụm tất cả fruit (có thể bị kick)",_G.BringFruitBF,function(value)
    ...
    Misc:Button("tham gia lại Server",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    ...
    Misc:Button("Hop đến sever ít người",function()
    ...
    Misc:Button("mở shop bán trái ác quỷ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    Misc:Button("mở túi đồ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")
        wait(1)
        game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
    end)
    
    Misc:Button("mở túi đồ trái ác quỷ",function()
...
Misc:Button("màu haki",function()
    ...
    Misc:Button("tham gia đội hải tặc",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Misc:Button("tham gia đội hải quân",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
    Misc:Seperator("Boost")
    
    Misc:Button("mở cổng",function()
    ...
    Misc:Button("tàng hình",function()
        game:GetService("Players").LocalPlayer.Character.LowerTorso:Destroy()
    end)
    
    Misc:Button("đồ vật nhấn tp",function()
    ...
    Misc:Dropdown("chọn code reset chỉ số",{"RESET_5B","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(value)
        _G.CodeSelect = value
    end)
    
    Misc:Button("nhập code (code đã chọn)",function()
    ...
    Misc:Toggle("chế độ rtx",_G.RTXMode,function(value)
        _G.RTXMode = value
    ...
    Misc:Toggle("Xóa Fog",RemoveFog,function(value)
        RemoveFog = value
    ...
    Misc:Toggle("xóa Damage",function()
    ...
    Misc:Button("mở khóa fps",function()
     ...
     Misc:Button("chế độ skin giả",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
    ...
    Misc:Toggle("ESP người chơi",false,function(value)
        ESPPlayer = value
    ...
    Misc:Toggle("ESP rương",false,function(value)
        ChestESP = value
    ...
    Misc:Toggle("ESP trái ác quỷ",false,function(value)
        DevilFruitESP = value
    ...
    Misc:Toggle("ESP bông hoa",false,function(value)
        FlowerESP = value
    ...
    Misc:Toggle("vô hạn mana",false,function(value)
        InfiniteEnergy = value
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    Misc:Toggle("tự động mở tộc",_G.AutoAgility,function(value)
    ...
    Misc:Toggle("tộc vô hạn",true,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:Toggle("vô hạn sức chịu đựng haki quan sát",getgenv().InfiniteObRange,function(value)
    ...
    Misc:Toggle("đi trên nước",_G.WalkWater,function(value)
        _G.WalkWater = value
    end)
    ...
    Misc:Toggle("đi xuyên tường",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
